...
echo ""
echo "    kubectl port-forward -n ingress-nginx svc/ingress-nginx-controller --address 0.0.0.0 8085:80"
echo ""
echo "  Then open: http://localhost:8085"
echo "  (The --address 0.0.0.0 flag is required for WSL2 → Windows browser access)"
echo ""
